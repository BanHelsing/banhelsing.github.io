...
piso1 = [salas_piso1,baños_piso1,admin_piso1,deptos_piso1,labs_piso1,kiosco_piso1];
piso2 = [salas_piso2];
...
//Edificio E piso 1
var LabAltaTension = L.marker([2743, 804], {title:"Laboratorio de Alta Tension", riseOnHover: true, interactive: true});
...
//Edificio B
var labminas = L.marker([2980,1519], {title:"Laboratorio de Ing. civil en Minas", riseOnHover: true, interactive: true});
labs_piso1.push(labminas);

//Edificio C
var fablab = L.marker([2066,2765], {title:"FabLab", riseOnHover: true, interactive: true});
salas_piso1.push(fablab);
var deptoingdp = L.marker([1970,2785], {title:"Departamento de Ing. DP", riseOnHover: true, interactive: true});
deptos_piso1.push(deptoingdp);
var kiosco1 = L.marker([1824,2776], {title:"Kiosco", riseOnHover: true, interactive: true});
kiosco_piso1.push(kiosco1);//cambiar por el nombre del negocio del tio y la tia :D

//Edificio F Piso 1
var auditorio = L.marker([2684,2856], {title:"Auditorio", riseOnHover: true, interactive: true});
salas_piso1.push(auditorio);
var banoH_F1 = L.marker([2700,3040], {title:"Baño de Hombres", riseOnHover: true, interactive: true});
baños_piso1.push(banoH_F1);
var banoM_F1 = L.marker([2702,3050], {title:"Baño de Mujeres", riseOnHover: true, interactive: true});
baños_piso1.push(banoM_F1);
var banoD_F1 = L.marker([2724,3060], {title:"Baño", riseOnHover: true, interactive: true});
baños_piso1.push(banoD_F1);

var comedor = L.marker([2780,2336], {title:"Comedor", riseOnHover: true, interactive: true});
salas_piso1.push(comedor);


//Edificio CIAC por colocarle un nombre
var CIAC = L.marker([4089,2851], {title:"CIAC", riseOnHover: true, interactive: true});
salas_piso2.push(CIAC);
var NOAC = L.marker([4102,2929], {title:"NOAC", riseOnHover: true, interactive: true});
salas_piso1.push(NOAC);
var salaB014 = L.marker([3992,2536], {title:"salaB014", riseOnHover: true, interactive: true});
salas_piso1.push(salaB014);
var salaB015 = L.marker([3972,2442], {title:"salaB015", riseOnHover: true, interactive: true});
salas_piso1.push(salaB015);
var salaB001 = L.marker([3938,2283], {title:"salaB001", riseOnHover: true, interactive: true});
salas_piso1.push(salaB001);
var salaB002 = L.marker([3922,2204], {title:"salaB002", riseOnHover: true, interactive: true});
salas_piso1.push(salaB002);
var banoH_ciac1 = L.marker([3966,2369], {title:"Baño de Hombres", riseOnHover: true, interactive: true});
baños_piso1.push(banoH_ciac1); //cambiar nombre si es necesario
var banoM_ciac1 = L.marker([3960,2342], {title:"Baño de Mujeres", riseOnHover: true, interactive: true});
baños_piso1.push(banoM_ciac1); //cambiar nombre si es necesario
...
//labs_piso1
var labs_piso1_layer = L.layerGroup(labs_piso1)
labs_piso1_layer.addTo(map)

var kiosco_piso1_layer = L.layerGroup(kiosco_piso1)
kiosco_piso1_layer.addTo(map)

var piso1_layer = L.layerGroup(salas_piso1.concat(admin_piso1, deptos_piso1, baños_piso1, labs_piso1,kiosco_piso1))
